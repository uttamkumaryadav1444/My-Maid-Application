...
public class MaidController {
    ...
    public ResponseEntity<APIResponse> updateMaidLanguages(
            @PathVariable Long id,
        ...
        try {
            ...
            maid.setLanguages(languages);
            Maid updatedMaid = maidRepository.save(maid);

            MaidResponseDTO response = convertToMaidResponseDTO(updatedMaid);
            return ResponseEntity.ok(APIResponse.success("Languages updated successfully", response));
        } catch (Exception e) {
            return ResponseEntity.badRequest()
