...
public interface AuthService {
    ...
    // Verify OTP and Activate Account (Old method - for separate activation)
    OTPVerificationResponseDTO verifyAndActivate(String mobile, String otp, String userType);

    // ✅ NEW METHOD: Verify OTP and Auto-Activate Account (Single step)
    boolean verifyOTP(String mobile, String otp);

    // Token methods (optional but useful)
    String extractMobileFromToken(String token);
